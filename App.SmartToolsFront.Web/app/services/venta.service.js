...
var VentaService = /** @class */ (function () {
    function VentaService(_http, _configuration) {
        this._http = _http;
    ...
    VentaService.prototype.getAll = function () {
        return this._http.get(this.actionUrl)
            .map(function (res) {
            return res.json();
        }).catch(this.handleError);
    };
    VentaService.prototype.save = function (data) {
        var body = JSON.stringify(data);
        return this._http.post(this.actionUrl, body, this.options)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    VentaService.prototype.generaNotaVenta = function (IdVenta) {
        return this._http.get(this.actionUrl + 'generaNotaVenta/' + IdVenta)
            .map(function (res) {
            return res.json();
        }).catch(this.handleError);
    };
    VentaService.prototype.handleError = function (error) {
        console.error(error);
